...
public class RootController implements Initializable{
	...
	public void handleBtnAddAction() {
		...
		try {
			//BorderPane BP = FXMLLoader.load(getClass().getResource("AddForm.fxml")); 같다 밑에와
			...
			btnFormAdd.setOnAction(new EventHandler<ActionEvent>() {
				...
				public void handle(ActionEvent arg0) {
					...
					Student student = new Student(txtName.getText(),Integer.parseInt(txtKorean.getText()),Integer.parseInt(txtMath.getText()),
